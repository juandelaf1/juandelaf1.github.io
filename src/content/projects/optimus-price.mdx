...
<ArchitectureFlow stages={[
  [
    { label: "Booking History", sub: "18 months data" },
    { label: "Feature Engineering", sub: "Pandas, 40+ feats" },
    { label: "Random Forest", sub: "scikit-learn + Optuna" },
    { label: "Price API", sub: "FastAPI" },
    { label: "Dashboard", sub: "Streamlit" },
  ],
]} />
