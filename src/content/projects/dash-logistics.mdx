...
<ArchitectureFlow stages={[
  [
    { label: "Multi-Source", sub: "AAA + Weather + Census" },
    { label: "Quality Gate", sub: "Schema Validation" },
    { label: "Feature Matrix", sub: "ETL Pipeline" },
    { label: "XGBoost", sub: "Cost Prediction" },
    { label: "Streamlit", sub: "15+ KPIs" },
  ],
]} />
